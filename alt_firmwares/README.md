...
### First light - Frequency knob alt functionality
Green means octave switching, red means aux crossfade
...
Green means level (as in the base firmware), red means decay
