#!/usr/bin/env python3
"""Build the autonomous, exact-control wavetable equation CPU probe."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="wavetable-equation-autosweep-") as temp:
    ...
    print(f"Built autonomous wavetable probe: {args.output}")
    print("Cycle: 105.5 s; capture at least 211 s for a guaranteed full pass.")
    return 0
