...
MORPH is bell size. TWIST is the buzz — how far the lips swing into closure
...
flow, and the lip swings hard enough to slam shut. Across TWIST's range closure
...
TWIST's midpoint is the shipped instrument, bit-identical — deliberate, because
TWIST is Plaits' fourth control and rests at its midpoint whenever the menu is
...
Steepening (see above) was tried on TWIST first and measured well — 35 dB of
